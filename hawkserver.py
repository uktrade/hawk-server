...
def authenticate_hawk_header(
        lookup_credentials: Callable[[str], Optional[Dict]], seen_nonce: Callable[[str, str], bool], max_skew: int,
        header: str, method: str, host: str, port: str, path: str, content_type: str, content: bytes,
    ...
    if seen_nonce(parsed_header['nonce'], matching_credentials['id']):
